...
################ DER MAIN DEBUT #####################
def app():
	### I) channels already downloaded 100% successfully
	...
	### II)b) channels already downloaded but to redo table in English (for later)
	...
	### II)c) channels already downloaded but with some mysterious errors somewhere
	...
	### III) channels that need the program to be adjusted to work correctly
	leech.channel("Micmaths", False, "https://www.notion.so/930c45af3d1a401b952b0a1da57fb02d?v=9afa56a8a17641e99b4db486e81e3f80") ### Mickaël Launay
	...
	### IV) channels remaining to download
