...
################ DER MAIN DEBUT #####################
def app():
	## channels already downloaded : redo table with intelligent video index detected
	...
	## channels already downloaded : redo table in English (for later)
	...
	## channels that need the program to be adjusted to work correctly
	# leech.channel("Micmaths", False, "https://www.notion.so/930c45af3d1a401b952b0a1da57fb02d?v=9afa56a8a17641e99b4db486e81e3f80")
	## channels remaining to download
	leech.channel("UCcueC-4NWGuPFQKzQWn5heA", True, "https://www.notion.so/03b597b7607c4728bcb570e814e02a99?v=2396f2f45e3c4c4e97da84321f486d5e")
	leech.channel("UCLXDNUOO3EQ80VmD9nQBHPg", True, "https://www.notion.so/1a9d23934b244ca6be4c2085a5b7a231?v=5a0aa53c5ca640e4be2130b142447257")
