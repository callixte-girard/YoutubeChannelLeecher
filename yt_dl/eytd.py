    ...
    for vid_url in vids_urls:  
        ...
        while True:
            ...
            try:
                ...
                dl_links = all_html.find_all('div', attrs={'class':'eytd_list_item'}) ### includes header
        ...
        # print("video {} / {} — [ {} ] is being downloaded ... Please be patient ...".format(video_countesr, len(vids_urls), video_filename))
